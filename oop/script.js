...
// свойством name и методом bark(), который выводит сообщение о том, что собака лает. Используйте одалживание метода eat() из объекта Animal для объекта Dog,
...
//     name: null,
//     eat() {
//         console.log(`это ${this.name} кушает`);
//     }
// };
// const Dog = {
//     name: null,
...
// Создайте объект calculator с методами add(), subtract() и multiply(), которые выполняют соответствующие математические операции над
...
class BankAccount {
    ...
    withdraw(amount) { 
        if (amount > this.balance) {
            ...
            this.balance -= amount;
        console.log(`Вывод: Withdrawn ${amount} from account ${this.accountNumber}. New balance: ${this.balance}`);
        }
...
console.log(account1.bankName);

// Илья Щербаков https://github.com/azat-io/you-dont-know-js-ru